"""
Berani Curhat ke Elara – Halaman Publik (ASCII Safe)
"""
...
st.markdown("Tidak semua rasa harus dijawab. Cukup didengarkan... dan diabadikan dalam lembar yang penuh makna.")
